from shopify_inventory_mapping.shopify.graphql.queries import START_BULK_OPERATIONS, POLL_OPERATION_STATUS
from shopify_inventory_mapping.shopify.param_store_config import ParamStoreConfig
import logging
import requests
import os
...
class ShopifyAPI:
    ...
    def get_products_text(self):
        if self.products_url:
            LOGGER.info(f'Download products from {self.products_url}')
