...
class ShopifyConnector:
    ...
    def __init__(self, api_key, password, shop=None, url=None, host=SHOPIFY_HOST):
        self.host = host
    ...
    def get_orders(self, starts_at, ends_at, params, query=None, limit=250, page=1):
        """
